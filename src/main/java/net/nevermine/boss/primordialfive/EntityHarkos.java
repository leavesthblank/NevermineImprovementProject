...
public class EntityHarkos extends EntityMob implements EntityBoss {
	private int musicTick;

	public EntityHarkos(final World par1World) {
		super(par1World);
		setSize(1.2f, 2.1f);
	}

	public EntityHarkos(final World par1World, final int music) {
		this(par1World);
		musicTick = music;
	}
	...
	private void transform() {
		if (!worldObj.isRemote) {
			final EntityRaxxan var2 = new EntityRaxxan(worldObj, musicTick);
