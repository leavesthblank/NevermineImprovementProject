...
public class EntitySkelemanElite extends EntityMob implements IRangedAttackMob {
	public EntitySkelemanElite(final World par1World) {
		super(par1World);
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntitySkelemanShot var2 = new EntitySkelemanShot(worldObj, this, 7.0f);
		...
		playSound("nevermine:SkelemanShot", 1.0f, 1.0f / (getRNG().nextFloat() * 0.4f + 0.8f));
