...
public class EntityGuardianRed extends EntityMob implements IRangedAttackMob, EntityBoss {
	...
	public EntityGuardianRed(final World par1World) {
		super(par1World);
	...
	private Item dropStatue() {
		return Item.getItemFromBlock(SpecialBlockizer.GuardianStatueRed);
	}
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntityGuardianProjectileRed var2 = new EntityGuardianProjectileRed(worldObj, this, 20.0f, 3);
	...
	public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
		...
		return (!par1DamageSource.isProjectile() || !(entity instanceof EntityGuardianProjectileGreen)) && !(entity instanceof EntityGuardianProjectileBlue) && !(entity instanceof EntityGuardianProjectileYellow) && super.attackEntityFrom(par1DamageSource, par2);
	}
}
