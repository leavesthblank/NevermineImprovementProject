...
public class EntityGuardianYellow extends EntityMob implements IRangedAttackMob, EntityBoss {
	private EntityAIArrowAttack aiArrowAttack;

	public EntityGuardianYellow(final World par1World) {
		super(par1World);
	...
	private Item dropStatue() {
		return Item.getItemFromBlock(SpecialBlockizer.GuardianStatueYellow);
	}
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntityGuardianProjectileYellow var2 = new EntityGuardianProjectileYellow(worldObj, this, 15.0f, 1);
	...
	public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
		...
		return (!par1DamageSource.isProjectile() || !(entity instanceof EntityGuardianProjectileGreen)) && !(entity instanceof EntityGuardianProjectileRed) && !(entity instanceof EntityGuardianProjectileBlue) && super.attackEntityFrom(par1DamageSource, par2);
	}
}
