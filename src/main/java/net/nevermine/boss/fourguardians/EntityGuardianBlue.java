...
public class EntityGuardianBlue extends EntityMob implements IRangedAttackMob, EntityBoss {
	private EntityAIArrowAttack aiArrowAttack;

	public EntityGuardianBlue(final World par1World) {
		super(par1World);
	...
	private Item dropStatue() {
		return Item.getItemFromBlock(SpecialBlockizer.GuardianStatueBlue);
	}
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntityGuardianProjectileBlue var2 = new EntityGuardianProjectileBlue(worldObj, this, 20.0f, 4);
	...
	public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
		...
		return (!par1DamageSource.isProjectile() || !(entity instanceof EntityGuardianProjectileGreen)) && !(entity instanceof EntityGuardianProjectileRed) && !(entity instanceof EntityGuardianProjectileYellow) && super.attackEntityFrom(par1DamageSource, par2);
	}
}
