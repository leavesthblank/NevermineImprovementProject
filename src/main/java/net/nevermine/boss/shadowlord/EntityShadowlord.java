...
public class EntityShadowlord extends EntityMob implements IRangedAttackMob, EntityBoss {
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		...
		if (rand.nextBoolean()) {
			dropItem(Weaponizer.Grenade, 200 + rand.nextInt(200));
		}
		else {
			dropItem(Itemizer.CannonBall, 50 + rand.nextInt(50));
		}
	}
	...
	static {
		attackEntitySelector = par1Entity -> par1Entity instanceof EntityLivingBase && ((EntityLivingBase)par1Entity).getCreatureAttribute() != EnumCreatureAttribute.UNDEAD;
	}
}
