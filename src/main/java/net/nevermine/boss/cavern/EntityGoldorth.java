...
public class EntityGoldorth extends EntityMob implements CavernBoss {
	public EntityGoldorth(final World par1World) {
		super(par1World);
		setSize(2.2f, 2.9f);
	}

	protected String getLivingSound() {
		return "nevermine:GoldorthLiving";
	}

	protected String getDeathSound() {
		return "nevermine:GoldorthDeath";
	}

	protected String getHurtSound() {
		return "nevermine:GoldorthHit";
	}
	...
	protected void dropFewItems(final boolean par1, final int par2) {
        dropItem(Weaponizer.PlutonScythe, 1);
        dropItem(Weaponizer.PlutonStickler, 1);
        dropItem(Item.getItemFromBlock(SpecialBlockizer.PlutonBanner), 1);
        dropItem(Item.getItemFromBlock(SpecialBlockizer.GoldorthStatue), 1);
	}
