...
public class EntityCottonCandor extends EntityAIFlying implements EntityBoss, EntitySpecialRange {
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		...
		dropItem(Item.getItemFromBlock(Blockizer.CandylandCottonBlue), 64 + rand.nextInt(65));
		dropItem(Item.getItemFromBlock(Blockizer.CandylandCottonPink), 64 + rand.nextInt(65));
