...
public class EntityLottomanLborean extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanLborean(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManLBorean." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsLborean, 10, 1), new ItemStack(Totemizer.TotemAquaticStaff)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsLborean, 10, 1), new ItemStack(Totemizer.TotemTidalGreatblade)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsLborean, 40, 1), new ItemStack(Itemizer.CoinsLborean, 35), new ItemStack(Totemizer.TotemAquaticStaff, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsLborean, 40, 1), new ItemStack(Itemizer.CoinsLborean, 35), new ItemStack(Totemizer.TotemTidalGreatblade, 10)));
