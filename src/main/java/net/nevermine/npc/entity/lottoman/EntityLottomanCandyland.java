...
public class EntityLottomanCandyland extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanCandyland(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManCandyland." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsCandyland, 10, 1), new ItemStack(Totemizer.TotemFroster)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsCandyland, 10, 1), new ItemStack(Totemizer.TotemMintMagnum)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsCandyland, 40, 1), new ItemStack(Itemizer.CoinsCandyland, 35), new ItemStack(Totemizer.TotemFroster, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsCandyland, 40, 1), new ItemStack(Itemizer.CoinsCandyland, 35), new ItemStack(Totemizer.TotemMintMagnum, 10)));
