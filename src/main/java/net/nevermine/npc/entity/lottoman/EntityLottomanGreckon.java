...
public class EntityLottomanGreckon extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanGreckon(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManGreckon." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsGreckon, 10, 1), new ItemStack(Totemizer.TotemHauntersRifle)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsGreckon, 10, 1), new ItemStack(Totemizer.TotemViper1)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsGreckon, 40, 1), new ItemStack(Itemizer.CoinsGreckon, 35), new ItemStack(Totemizer.TotemHauntersRifle, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsGreckon, 40, 1), new ItemStack(Itemizer.CoinsGreckon, 35), new ItemStack(Totemizer.TotemViper1, 10)));
