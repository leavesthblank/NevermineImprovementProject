...
public class EntityLottomanLelyetia extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanLelyetia(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManLelyetia." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsLelyetia, 10, 1), new ItemStack(Totemizer.TotemSwarmotron)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsLelyetia, 10, 1), new ItemStack(Totemizer.TotemRoyalGreatblade)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsLelyetia, 40, 1), new ItemStack(Itemizer.CoinsLelyetia, 35), new ItemStack(Totemizer.TotemSwarmotron, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsLelyetia, 40, 1), new ItemStack(Itemizer.CoinsLelyetia, 35), new ItemStack(Totemizer.TotemRoyalGreatblade, 10)));
