...
public class EntityLottomanIromine extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanIromine(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManIromine." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsIromine, 10, 1), new ItemStack(Totemizer.TotemMechaBlaster)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsIromine, 10, 1), new ItemStack(Totemizer.TotemExplochronSword)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsIromine, 40, 1), new ItemStack(Itemizer.CoinsIromine, 35), new ItemStack(Totemizer.TotemMechaBlaster, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsIromine, 40, 1), new ItemStack(Itemizer.CoinsIromine, 35), new ItemStack(Totemizer.TotemExplochronSword, 10)));
