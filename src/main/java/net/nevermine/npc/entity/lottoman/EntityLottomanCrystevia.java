...
public class EntityLottomanCrystevia extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanCrystevia(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManCrystevia." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsCrystevia, 10, 1), new ItemStack(Totemizer.TotemCrystaneer)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsCrystevia, 10, 1), new ItemStack(Totemizer.TotemCrystalMaul)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsCrystevia, 40, 1), new ItemStack(Itemizer.CoinsCrystevia, 35), new ItemStack(Totemizer.TotemCrystaneer, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsCrystevia, 40, 1), new ItemStack(Itemizer.CoinsCrystevia, 35), new ItemStack(Totemizer.TotemCrystalMaul, 10)));
