...
public class EntityLottomanDeeplands extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanDeeplands(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManDeeplands." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsDeeplands, 10, 1), new ItemStack(Totemizer.TotemFormationStaff)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsDeeplands, 10, 1), new ItemStack(Totemizer.TotemPredatiousBow)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsDeeplands, 40, 1), new ItemStack(Itemizer.CoinsDeeplands, 35), new ItemStack(Totemizer.TotemFormationStaff, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsDeeplands, 40, 1), new ItemStack(Itemizer.CoinsDeeplands, 35), new ItemStack(Totemizer.TotemPredatiousBow, 10)));
