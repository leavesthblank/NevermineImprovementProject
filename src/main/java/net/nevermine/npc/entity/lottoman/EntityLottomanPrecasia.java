...
public class EntityLottomanPrecasia extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanPrecasia(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManPrecasia." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsPrecasian, 10, 1), new ItemStack(Totemizer.TotemAbominator)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsPrecasian, 10, 1), new ItemStack(Totemizer.TotemAncientBow)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsPrecasian, 40, 1), new ItemStack(Itemizer.CoinsPrecasian, 35), new ItemStack(Totemizer.TotemAbominator, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsPrecasian, 40, 1), new ItemStack(Itemizer.CoinsPrecasian, 35), new ItemStack(Totemizer.TotemAncientBow, 10)));
