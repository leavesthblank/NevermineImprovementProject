...
public class EntityLottomanDustopia extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanDustopia(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManDustopia." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsDustopia, 10, 1), new ItemStack(Totemizer.TotemTerminator)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsDustopia, 10, 1), new ItemStack(Totemizer.TotemDaybreaker)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsDustopia, 40, 1), new ItemStack(Itemizer.CoinsDustopia, 35), new ItemStack(Totemizer.TotemTerminator, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsDustopia, 40, 1), new ItemStack(Itemizer.CoinsDustopia, 35), new ItemStack(Totemizer.TotemDaybreaker, 10)));
