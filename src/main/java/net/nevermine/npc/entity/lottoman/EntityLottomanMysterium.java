...
public class EntityLottomanMysterium extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLottomanMysterium(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lottoManMysterium." + rand.nextInt(5)));
	}
	...
	public void addRecipies(final MerchantRecipeList list) {
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsMysterium, 10, 1), new ItemStack(Totemizer.TotemSoundCannon)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsMysterium, 10, 1), new ItemStack(Totemizer.TotemPenguinBlaster)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsMysterium, 40, 1), new ItemStack(Itemizer.CoinsMysterium, 35), new ItemStack(Totemizer.TotemSoundCannon, 10)));
		list.add(new RestockedRecipe(new ItemStack(Itemizer.CoinsMysterium, 40, 1), new ItemStack(Itemizer.CoinsMysterium, 35), new ItemStack(Totemizer.TotemPenguinBlaster, 10)));
