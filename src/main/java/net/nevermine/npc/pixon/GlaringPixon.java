...
import net.nevermine.fx.trail.BrownTrail;
import net.nevermine.izer.Itemizer;

public class GlaringPixon extends EntityAnimal {
	public GlaringPixon(final World par1World) {
		super(par1World);
		setSize(0.9f, 1.3f);
	...
	public boolean interact(final EntityPlayer par1EntityPlayer) {
		PixonCollection.collect(this, par1EntityPlayer, 70, 25, Itemizer.iStoneGlaring);
		return super.interact(par1EntityPlayer);
	}

	public EntityAgeable createChild(final EntityAgeable var1) {
		return new GlaringPixon(worldObj);
	}
	...
	public void onUpdate() {
		...
		if (worldObj.isRemote) {
			for (int var3 = 0; var3 < 8; ++var3) {
				final BrownTrail var4 = new BrownTrail(worldObj, posX, posY + 1.0, posZ, 0.0, 0.0, 0.0, 5);
