...
public class SoulstoneAxe extends ItemAxe{

	public SoulstoneAxe(final Item.ToolMaterial p_i45327_1_) {
		super(p_i45327_1_);
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		list.add(StringUtil.getColourLocaleString("item.SoulstoneAxe.desc.1", EnumChatFormatting.DARK_GREEN));
