...
public class EntityDyrehorn extends EntityMob {
	...
	protected String getLivingSound() {
		return "nevermine:DyrehornLiving";
	}

	protected String getDeathSound() {
		return "nevermine:DyrehornDeath";
	}

	protected String getHurtSound() {
		return "nevermine:DyrehornHit";
	}
	...
	public void applyEntityAttributes() {
		...
		getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(110.0);
	}

	public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
		final Entity entity = par1DamageSource.getSourceOfDamage();
		return !par1DamageSource.isFireDamage() && !par1DamageSource.isMagicDamage() && !par1DamageSource.isExplosion() && super.attackEntityFrom(par1DamageSource, par2);
	}
