...
public class EntityFungik extends EntityMob implements IRangedAttackMob {
	private EntityAIArrowAttack aiArrowAttack;

	public EntityFungik(final World par1World) {
		super(par1World);
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntityFungiShot var2 = new EntityFungiShot(worldObj, this, 3.5f, 0);
		...
		playSound("nevermine:FungikShot", 1.5f, 1.0f / (getRNG().nextFloat() * 0.4f + 0.8f));
