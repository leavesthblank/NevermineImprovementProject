...
public class EntityUrka extends EntityMob {
	public EntityUrka(final World par1World) {
		super(par1World);
		setSize(1.2f, 1.5f);
	}

	protected String getLivingSound() {
		return "nevermine:UrkaLiving";
	}

	protected String getDeathSound() {
		return "nevermine:UrkaDeath";
	}

	protected String getHurtSound() {
		return "nevermine:UrkaHit";
	}

	protected void dropFewItems(final boolean par1, final int par2) {
        dropItem(Itemizer.UrkaHide, rand.nextInt(2));
	}
