...
public class EntityKoko extends EntityMob {
	public EntityKoko(final World par1World) {
		super(par1World);
		setSize(0.6f, 2.0f);
	}
	...
	public boolean attackEntityAsMob(final Entity par1) {
		if (super.attackEntityAsMob(par1)) {
			if (par1 instanceof EntityLivingBase) {
				((EntityLivingBase)par1).addPotionEffect(new PotionEffect(Potion.blindness.id, 100, 35));
			}
			return true;
		}
		return false;
