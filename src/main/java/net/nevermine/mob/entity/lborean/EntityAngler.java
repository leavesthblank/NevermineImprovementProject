...
public class EntityAngler extends EntityMob {
	public EntityAngler(final World par1World) {
		super(par1World);
		setSize(1.2f, 1.6f);
	}

	protected String getLivingSound() {
		return "nevermine:AnglerLiving";
	}

	protected String getDeathSound() {
		return "nevermine:AnglerDeath";
	}

	protected String getHurtSound() {
		return "nevermine:AnglerHit";
	}
	...
	public void onLivingUpdate() {
		...
		final EntityPlayer var1 = worldObj.getClosestVulnerablePlayerToEntity(this, 8.0);
		if (var1 == null || var1.capabilities.isCreativeMode || var1.getDistanceToEntity(this) > 8.0f) {
			return;
		}
		var1.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 35, 1));
	}
