...
public class EntitySeaTroll extends EntityMob implements IRangedAttackMob {
	private EntityAIArrowAttack aiArrowAttack;

	public EntitySeaTroll(final World par1World) {
		super(par1World);
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntityMagicBallSeaTroll var2 = new EntityMagicBallSeaTroll(worldObj, this, 6.0f, 2);
