...
public class EntityExohead extends EntityMob{

	public EntityExohead(final World par1World) {
		super(par1World);
		setSize(0.95f, 1.5f);
	}

	protected String getLivingSound() {
		return "nevermine:ExoheadLiving";
	}

	protected String getDeathSound() {
		return "nevermine:ExoheadDeath";
	}

	protected String getHurtSound() {
		return "nevermine:ExoheadHit";
	}
	...
	public void onDeath(final DamageSource var1) {
		...
		if (!worldObj.isRemote && var1.getEntity() != null && var1.getEntity() instanceof EntityPlayer) {
			PlayerContainer.getProperties((EntityPlayer)var1.getEntity()).addExperience(850.0f, Hunter);
		}
	}
