...
public class EntityFlye extends EntityAIFlying {
	private ChunkCoordinates currentFlightTarget;
	private int flyTimer;

	public EntityFlye(final World var1) {
		super(var1);
	...
	protected String getLivingSound() {
		return "nevermine:FlyeLiving";
	}

	protected String getHurtSound() {
		return "nevermine:FlyeHit";
	}

	protected String getDeathSound() {
		return "nevermine:FlyeDeath";
	}
