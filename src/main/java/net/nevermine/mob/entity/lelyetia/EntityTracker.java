...
public class EntityTracker extends EntityMob {
	public EntityTracker(final World par1World) {
		super(par1World);
		setSize(0.95f, 1.9f);
	}

	protected String getLivingSound() {
		return "nevermine:TrackerLiving";
	}

	protected String getDeathSound() {
		return "nevermine:TrackerDeath";
	}

	protected String getHurtSound() {
		return "nevermine:TrackerHit";
	}
