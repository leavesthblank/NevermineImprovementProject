...
public class EntityRawbone extends EntityMob{
	...
	protected String getLivingSound() {
		return "nevermine:RawboneLiving";
	}

	protected String getDeathSound() {
		return "nevermine:RawboneDeath";
	}

	protected String getHurtSound() {
		return "nevermine:RawboneHit";
	}
	...
	public void onDeath(final DamageSource var1) {
		...
		if (!worldObj.isRemote && var1.getEntity() != null && var1.getEntity() instanceof EntityPlayer) {
			PlayerContainer.getProperties((EntityPlayer)var1.getEntity()).addExperience(1000.0f, Hunter);
		}
	}
	...
	public boolean attackEntityAsMob(final Entity par1) {
		if (super.attackEntityAsMob(par1)) {
			if (par1 instanceof EntityLivingBase) {
				((EntityLivingBase)par1).addPotionEffect(new PotionEffect(Potion.hunger.id, 250, 2));
			}
			return true;
		}
		return false;
