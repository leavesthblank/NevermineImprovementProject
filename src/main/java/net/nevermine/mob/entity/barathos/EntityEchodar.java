...
public class EntityEchodar extends EntityAIFlying {
	private ChunkCoordinates currentFlightTarget;
	private int flyTimer;

	public EntityEchodar(final World var1) {
		super(var1);
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		if (rand.nextInt(40) >= 37) {
			dropItem(Weaponizer.EchoGull, 1);
		}
	...
	protected void applyEntityAttributes() {
		...
		getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.550000011920929);
	...
	protected String getLivingSound() {
		return "nevermine:EchodarLiving";
	}

	protected String getHurtSound() {
		return "nevermine:EchodarHit";
	}

	protected String getDeathSound() {
		return "nevermine:EchodarDeath";
	}
