...
public class EntityConstructSpeed extends EntityMob {
	public EntityConstructSpeed(final World par1World) {
		super(par1World);
		setSize(1.0f, 2.1f);
	}
	...
	protected void dropFewItems(final boolean par1, final int par2) {
        ...
        dropItem(Itemizer.GemstonesYellow, rand.nextInt(4));
	}

	public boolean getCanSpawnHere() {
		return worldObj.difficultySetting != EnumDifficulty.PEACEFUL && worldObj.checkNoEntityCollision(boundingBox) && worldObj.getCollidingBoundingBoxes(this, boundingBox).isEmpty();
	}
