...
public class EntitySkellox extends EntityMob {
	public EntitySkellox(final World par1World) {
		super(par1World);
		setSize(1.0f, 2.25f);
	}

	protected String getLivingSound() {
		return "nevermine:SkelloxLiving";
	}

	protected String getDeathSound() {
		return "nevermine:SkelloxDeath";
	}

	protected String getHurtSound() {
		return "nevermine:SkelloxHit";
	}
