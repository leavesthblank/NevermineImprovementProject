...
public class EntityAnemia extends EntityFlying implements IMob, EntityNoRange {
	...
	public boolean getCanSpawnHere() {
		return worldObj.difficultySetting != EnumDifficulty.PEACEFUL && worldObj.checkNoEntityCollision(boundingBox) && BloodHuntEvent.isHunt() && worldObj.getCollidingBoundingBoxes(this, boundingBox).isEmpty() && !worldObj.isAnyLiquid(boundingBox) && rand.nextInt(4) == 2;
	}
