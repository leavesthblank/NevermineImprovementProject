...
public class EntitySeeker extends EntityAIFlying {
	private ChunkCoordinates currentFlightTarget;
	private int flyTimer;

	public EntitySeeker(final World var1) {
		super(var1);
	...
	protected String getLivingSound() {
		return "nevermine:SeekerLiving";
	}

	protected String getHurtSound() {
		return "nevermine:SeekerHit";
	}

	protected String getDeathSound() {
		return "nevermine:SeekerDeath";
	}
