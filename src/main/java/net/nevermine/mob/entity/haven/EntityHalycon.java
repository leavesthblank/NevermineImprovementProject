...
public class EntityHalycon extends EntityAnimal {
	public EntityHalycon(final World par1World) {
		super(par1World);
		setSize(0.9f, 1.3f);
	...
	public boolean getCanSpawnHere() {
		return worldObj.difficultySetting != EnumDifficulty.PEACEFUL && worldObj.checkNoEntityCollision(boundingBox) && worldObj.getCollidingBoundingBoxes(this, boundingBox).isEmpty() && !worldObj.isAnyLiquid(boundingBox) && rand.nextInt(15) == 9;
	}
	...
	public EntityAgeable createChild(final EntityAgeable var1) {
		return new EntityHalycon(worldObj);
	}
}
