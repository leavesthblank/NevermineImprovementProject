...
public class EntityRuneTemplarGreenDisabled extends EntityCreature {
	...
	public boolean interact(final EntityPlayer par1EntityPlayer) {
		...
		if (par1EntityPlayer.inventory.hasItem(Itemizer.RunicEnergy) && par1EntityPlayer.inventory.hasItem(Itemizer.PoisonRune) && par1EntityPlayer.inventory.consumeInventoryItem(Itemizer.LifeRune) && par1EntityPlayer.inventory.consumeInventoryItem(Itemizer.RunicEnergy) && !worldObj.isRemote) {
			final EntityRuneTemplarGreen var3 = new EntityRuneTemplarGreen(worldObj);
