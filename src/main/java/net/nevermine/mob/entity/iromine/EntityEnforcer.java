...
public class EntityEnforcer extends EntityMob {
	public EntityEnforcer(final World par1World) {
		super(par1World);
		setSize(0.6f, 1.5f);
	}

	protected String getLivingSound() {
		return "nevermine:EnforcerLiving";
	}

	protected String getDeathSound() {
		return "nevermine:EnforcerDeath";
	}

	protected String getHurtSound() {
		return "nevermine:EnforcerHit";
	}
