...
public class RenderFishShot extends Render {
	private static ResourceLocation EntityTexture;

	public void doRender(final EntityThrowable par1EntityArrow, final double par2, final double par4, final double par6, final float par8, final float par9) {
	...
	protected ResourceLocation getEntityTexture(final EntityThrowable par1EntityArrow) {
		return RenderFishShot.EntityTexture;
	}

	protected ResourceLocation getEntityTexture(final Entity par1Entity) {
		return getEntityTexture((EntityThrowable)par1Entity);
	}

	public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6, final float par8, final float par9) {
		doRender((EntityThrowable)par1Entity, par2, par4, par6, par8, par9);
	}

	static {
		RenderFishShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/penguinShot.png");
	}
}
