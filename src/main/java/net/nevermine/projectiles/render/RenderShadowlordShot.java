...
public class RenderShadowlordShot extends Render {
	...
	public void doRender(final EntityShadowlordShot par1EntityWitherSkull, final double par2, final double par4, final double par6, final float par8, final float par9) {
		GL11.glPushMatrix();
		GL11.glDisable(2884);
	...
	protected ResourceLocation getEntityTexture(final EntityShadowlordShot par1EntityWitherSkull) {
		return par1EntityWitherSkull.isInvulnerable() ? RenderShadowlordShot.invulnerableWitherTextures : RenderShadowlordShot.witherTextures;
	}

	protected ResourceLocation getEntityTexture(final Entity par1Entity) {
		return getEntityTexture((EntityShadowlordShot)par1Entity);
	}

	public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6, final float par8, final float par9) {
		doRender((EntityShadowlordShot)par1Entity, par2, par4, par6, par8, par9);
	}

	static {
		invulnerableWitherTextures = new ResourceLocation("nevermine:textures/projectiles/invisible3D.png");
		witherTextures = new ResourceLocation("nevermine:textures/projectiles/invisible3D.png");
	}
}
