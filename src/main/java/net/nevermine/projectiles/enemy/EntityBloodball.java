...
public class EntityBloodball extends EntityThrowable {
	...
	public EntityBloodball(final World par1World, final EntityMob entityGoblin, final float dmg, final int color) {
	...
	public void onEntityUpdate() {
		...
		for (int var3 = 0; var3 < 8; ++var3) {
			final RedTrail var4 = new RedTrail(worldObj, posX, posY, posZ, 0.0, 0.0, 0.0, 5);
