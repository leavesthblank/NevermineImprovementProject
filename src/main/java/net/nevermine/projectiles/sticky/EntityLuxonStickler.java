...
public class EntityLuxonStickler extends EntityThrowable {
	...
	public EntityLuxonStickler(final World par1World) {
		super(par1World);
		age = 0;
	}

	public EntityLuxonStickler(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg, final EntityLivingBase entityhit) {
