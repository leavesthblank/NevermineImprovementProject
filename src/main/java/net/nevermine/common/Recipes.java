...
public class Recipes {
    ...
    public static void init() {
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(Itemizer.MetalPellet, 32), new Object[]{Itemizer.IngotLimonite});
        ...
        GameRegistry.addRecipe(new ItemStack(Itemizer.TrollIdol, 1), new Object[]{"GMG", "HXH", " G ", 'G', Items.stick, 'H', Items.string, 'X', Items.gold_ingot, 'M', Items.leather});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletAgility, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Armorizer.AlacrityBoots});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletCombat, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Weaponizer.BloodstoneSword});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletFireResistance, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Armorizer.InfernalChestplate});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletFuryMining, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Toolizer.EmberstonePickaxe});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletGills, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Itemizer.CoralStone});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletGravity, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Weaponizer.GravityBlaster});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletInvisibility, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Itemizer.GhostlyPowder});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletRegeneration, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Weaponizer.RejuvenationStaff});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletNightVision, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Items.blaze_rod});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletResistance, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Itemizer.RammerheadHide});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletSpeed, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Armorizer.SpeedBoots});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletStrength, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Weaponizer.HorizonMaul});
        ...
        GameRegistry.addRecipe(new ItemStack(Itemizer.HauntedIdol, 1), new Object[]{"XY ", " Z ", " YX", 'X', Itemizer.GhoulasmPrimed, 'Y', Items.string, 'Z', Itemizer.Ghoulasm});
        GameRegistry.addShapelessRecipe(new ItemStack(Itemizer.CallOfTheDrake, 1), new Object[]{Itemizer.PureCoralStone, Itemizer.PureRainStone, Itemizer.PureWaterStone});
        GameRegistry.addShapelessRecipe(new ItemStack(Itemizer.CoralCloggerWaterlogged, 1), new Object[]{Itemizer.PureCoralStone, Itemizer.PureRainStone, Itemizer.PureWaterStone, Weaponizer.NethengeicSlugger});
        ...
        GameRegistry.addRecipe(new ItemStack(Armorizer.HazmatHelmet, 1), new Object[]{"GXG", "U U", 'G', Items.iron_ingot, 'X', new ItemStack(Items.coal,1,1), 'U', Blocks.wool});
        GameRegistry.addRecipe(new ItemStack(Armorizer.HazmatBoots, 1), new Object[]{"G G", "X X", 'G', Items.iron_ingot, 'X', Blocks.wool});
        GameRegistry.addRecipe(new ItemStack(Armorizer.HazmatLeggings, 1), new Object[]{"XGX", "G G", "X X", 'G', Blocks.wool, 'X', Items.iron_ingot});
        GameRegistry.addRecipe(new ItemStack(Armorizer.HazmatChestplate, 1), new Object[]{"G G", "XGX", "GXG", 'G', Items.iron_ingot, 'X', Blocks.wool});
        ...
        GameRegistry.addRecipe(new ItemStack(Weaponizer.WindStaff, 1), new Object[]{" G ", " X ", " X ", 'G', Itemizer.WindRune, 'X', Items.stick});
        GameRegistry.addRecipe(new ItemStack(Weaponizer.WaterStaff, 1), new Object[]{" G ", " X ", " X ", 'G', Itemizer.WaterRune, 'X', Items.stick});
        GameRegistry.addRecipe(new ItemStack(Weaponizer.FireStaff, 1), new Object[]{" G ", " X ", " X ", 'G', Itemizer.FireRune, 'X', Items.stick});
        GameRegistry.addRecipe(new ItemStack(Weaponizer.WitherStaff, 1), new Object[]{" G ", " X ", " X ", 'G', Itemizer.WitherRune, 'X', Items.stick});
        GameRegistry.addRecipe(new ItemStack(Weaponizer.PoisonStaff, 1), new Object[]{" G ", " X ", " X ", 'G', Itemizer.PoisonRune, 'X', Items.stick});
        ...
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletEnergy, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Itemizer.LunaGlobe});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletCreation, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Itemizer.EmptySlab});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletVitality, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Items.lava_bucket});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletHunger, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Itemizer.FurlionChop});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletDebuff, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Itemizer.GoldicapPedals});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletDivine, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Armorizer.RunicHelmet});
        GameRegistry.addRecipe(new ItemStack(Tabletizer.TabletPeace, 1), new Object[]{"GGG", "GXG", "GGG", 'G', Blocks.cobblestone, 'X', Armorizer.UtopianHelmet});
